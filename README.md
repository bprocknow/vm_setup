...
- Restarted runs reassess network reachability from the current boot only; historical IPs from older appended serial-log sessions are not reused as current SSH coordinates.
